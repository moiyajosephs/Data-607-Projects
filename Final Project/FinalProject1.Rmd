...
```{r}
ratings <- read.csv("https://github.com/moiyajosephs/Data-607-Projects/blob/main/Final%20Project/ratings_Beauty.csv", header = TRUE, sep = ",", dec = ".")
...
## Conclusions
This was interesting to use to see which items would be the topN. Future iteratoins of the project could search for the item by the idea. This could be something useful for a business. 
